    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
          ...
          <Link
            to="/projects"
            className="px-6 py-2 rounded-lg bg-gradient-to-r from-gray-900 via-black to-gray-900 
             text-white border border-gray-700 font-semibold shadow-lg 
      ...
      {/* Main Content */}
      <div className="flex flex-col items-center justify-center flex-1 px-6 py-12 pt-24 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl w-full px-2">
          ...
          <div className="p-6 bg-gray-800 rounded-xl shadow-lg">
            ...
            <p className="text-gray-400 text-sm md:text-base">
              Organize tasks visually, track progress, and keep your team
              aligned.
            </p>
          </div>
          <div className="p-6 bg-gray-800 rounded-xl shadow-lg">
        ...
        <div className="mt-20 max-w-3xl w-full px-2">
          ...
          <ul className="space-y-4 text-gray-300 text-sm md:text-base">
            ...
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✔</span>
              Simplify collaboration with real-time boards, chat, and
              whiteboards.
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✔</span>
              Stay organized with task tracking, role-based access, and version
              control.
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✔</span>
